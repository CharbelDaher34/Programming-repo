...
cloudant_username = '63cb4743-95f3-4f28-8243-8360fb50c33c-bluemix'
cloudant_api_key = 'W14paPkeXAxfg0CZNV9eQKDleuONZJkJSeIwYmIgpywH'
cloudant_url = 'https://63cb4743-95f3-4f28-8243-8360fb50c33c-bluemix.cloudantnosqldb.appdomain.cloud'
...
def post_review():
    ...
    review_data = json.loads(request.json)
